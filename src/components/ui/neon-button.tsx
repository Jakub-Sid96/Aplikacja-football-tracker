...
const buttonVariants = cva(
    "relative group border mx-auto text-center rounded-full cursor-pointer",
    {
        variants: {
            variant: {
                default: "bg-blue-500/5 hover:bg-blue-500/0 border-blue-500/20 text-slate-800",
                solid: "bg-[#0f172a] hover:bg-[#1e293b] text-white border-blue-500/20 transition-all duration-200",
                dark: "bg-[var(--dark)] hover:bg-[var(--dark)] text-white border-blue-500/25 transition-all duration-200 active:scale-[0.97]",
